<div class="w3-top">
  <div class="w3-bar w3-white w3-card w3-small" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="search.php" class="js-scroll-trigger w3-button w3-black w3-medium w3-wide w3-margin-top w3-margin-bottom w3-margin-left w3-margin-right"><i class="fa fa-search w3-medium w3-wide"> </i> Search </a>
    </div>
...
<nav class="w3-sidebar w3-bar-block w3-light w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="search.php'" class="w3-button w3-black w3-small w3-wide  w3-margin-top w3-margin-bottom w3-margin-left w3-margin-right"><i class="fa fa-search w3-small w3-wide"> </i> Search </a>
</nav>
